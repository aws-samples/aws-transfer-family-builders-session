...
The usage of ICD-10 codes in this lab are for educational purposes. The ICD-10 codes and descriptions used for this workshop are in the file **CommonICD10Codes.csv**. At the time of publication, their link for [registering for non-commercial use](https://www.who.int/standards/classifications/apps/icd/ClassificationDownload) is inactive resulting in an error stating, "This page cannot be found The page or file you are trying to access cannot be found. This is because the web address is incorrect or the file has been moved or deleted. In 2020, we migrated our web content to a new system so some older content may no longer be available online or at the same place." 
